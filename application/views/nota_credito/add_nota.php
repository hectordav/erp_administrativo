<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="table-label">
				<h4><strong>Nota de Credito<strong></h4>
				</div>
			<div class="form-container table-container">
				<form id="form-guardar" class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>nota_credito/guardar_nota_credito" method="POST">
		<div class="col-md-12 col-sm-12 col-xs-12">
		<br>
				<div class="col-md-1 col-sm-1 col-xs-1">
					...
					<div class="col-md-1 col-sm-1 col-xs-1">
					  ...
					  <div class="col-md-1 col-sm-1 col-xs-1">
						<input type="text" name="txt_id_nota_credito" id="txt_id_nota_credito" class="form-control" value="<?=$id_nota_credito_2?>" required="required" readonly></div>
...
<hr>
  ...
  <strong></i></strong> &nbsp;Haga clic en Cargar Articulos, a continuacion ELIMINE los articulos que NO estarán en esta Nota de credito
</div>
	</div>
	<div class="col-md-2 col-sm-2 col-xs-2">
	<br>
...
<?php foreach ($factura->result() as $data): ?>
  ...
  <button type="submit" class="btn btn-primary">Guardar Nota de Credito</button>
  <button type="button" class="btn btn-danger"OnClick="eliminar_nota_credito(this)"value="<?=$id_nota_credito_2?>">Cancelar</button></P>
 </div>
