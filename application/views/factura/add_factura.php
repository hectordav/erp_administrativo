<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="form-container table-container">
				<form id="form-guardar" class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>factura/guardar_factura" method="POST">
		<div class="col-md-12 col-sm-12 col-xs-12">
		<br>
				<div class="col-md-1 col-sm-1 col-xs-1">
					...
					<div class="col-md-2 col-sm-2 col-xs-2">
						<h5 ><P ALIGN="RIGHT"><label># Factura:</label></h5 ></P>
					</div>
					  <div class="col-md-1 col-sm-1 col-xs-1">
						<input type="text" name="txt_id_factura" id="txt_id_factura" class="form-control" value="<?=$data->id_factura?>" required="required" readonly>
					  <?php endforeach ?>
					</div>
		</div>
<!--**********************************************************************************-->
...
<?php endforeach ?>
 ...
 <div class="col-md-8 col-sm-8 col-xs-8">
   ...
   <P ALIGN="RIGHT">
<?php foreach ($factura->result() as $data): ?>
<a data-toggle="modal" href="#mpagofactura"><button type="button" class="btn btn-md btn-primary">Procesar Factura</button></a>
  <button type="button" class="btn btn-danger"OnClick="eliminar_factura(this)"value="<?=$data->id_factura?>">Cancelar</button></P>
 </div>
<?php endforeach ?>
