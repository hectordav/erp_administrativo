<div class="modal fade "id="mfactura">
		        <div class="modal-dialog">
		          <div class="modal-content">
		            <div class="modal-header">
		<a href="<?= $this->config->base_url();?>factura">
		              <button type="button" class="close" aria-hidden="true">&times;</button></a>
		               <strong><h3><span class ="label label-warning">Nueva Factura</span></h3></strong>
		            </div> <!-- termina el header -->
					<div class="container">
						<div class="row">
	<form action="<?php echo $this->config->base_url();?>factura/add_factura" method="POST" accept-charset="utf-8">
	<br>
		...
		<div class="col-md-1 col-sm-1 col-xs-1">
			<a class="btn btn-success btn-sm" href="<?= $this->config->base_url();?>cliente/cargar_grilla/add"><i class="fa fa-plus"></i> &nbsp; Añadir Cliente</a>
		            ...
		            <div class="modal-footer">
		            	<left><button type="submit" class="btn btn-primary"><strong><i class="fa fa-plus-circle"></i>&nbsp; Crear Factura</strong></button></left>
		            	</form>
		            </div>
