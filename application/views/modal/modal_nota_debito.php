<div class="modal fade bs-example-modal-lg "id="mnotadebito">
		        <div class="modal-dialog">
		          <div class="modal-content">
		            <div class="modal-header">
		<a href="<?= $this->config->base_url();?>nota_debito">
		              <button type="button" class="close" aria-hidden="true">&times;</button></a>
		               <strong><h3><span class ="label label-warning">Nueva Nota de Debito</span></h3></strong>
		            </div> <!-- termina el header -->
					<div class="container">
						<div class="row">
	<form action="<?php echo $this->config->base_url();?>nota_debito/add_nota_debito" method="POST" accept-charset="utf-8">
	<br>
		   ...
		   <select class="selectpicker form-control" data-live-search="true" id="cb_id_factura" name="cb_id_factura"style="width:10px" required>
				  ...
				  <?php endif ?>
		            ...
		            <div class="modal-footer">
		            	<left><button type="submit" class="btn btn-primary"><strong><i class="fa fa-plus-circle"></i></i>&nbsp; Crear Nota de Debito</strong></button></left>
		            	</form>
		            </div>
