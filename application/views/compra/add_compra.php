<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="table-label">
				<h4><strong>Agregar Compra<strong></h4>
				</div>
			<div class="form-container table-container">
				<form id="form-guardar" class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>compra/guardar_compra" method="POST">
		<div class="col-md-12 col-sm-12 col-xs-12">
		<br>
				<div class="col-md-1 col-sm-1 col-xs-1">
						<h5 ><P ALIGN="RIGHT"><label>Proveedor:</label></h5 ></P>
				</div>
					  <div class="col-md-5 col-sm-5 col-xs-5">
					  <?php foreach ($compra->result() as $data): ?>
							<input type="text" name="txt_cliente" id="txt_cliente" class="form-control" vrequired="required" value="RUT: <?=$data->proveedor_ruf ?> Nombre: <?=$data->proveedor_nombre ?>" readonly>
						</div>
						<div class="col-md-1 col-sm-1 col-xs-1">
					...
					<div class="col-md-2 col-sm-2 col-xs-2">
						<h5 ><P ALIGN="RIGHT"><label># Compra:</label></h5 ></P>
					</div>
					  <div class="col-md-1 col-sm-1 col-xs-1">
						<input type="text" name="txt_id_compra" id="txt_id_compra" class="form-control" value="<?=$data->id_compra?>" required="required" readonly>
					  <?php endforeach ?>
					</div>
		</div>
<!--**********************************************************************************-->
...
<?php endforeach ?>
 ...
 <div class="col-md-8 col-sm-8 col-xs-8">
  ...
  <a href="<?php echo $this->config->base_url();?>compra"><button type="button" class="btn btn-danger">Cancelar</button></a></P>
 </div>
