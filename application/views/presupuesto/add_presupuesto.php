<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="table-label">
				<h4><strong>Agregar Cotizacion<strong></h4>
				</div>
			<div class="form-container table-container">
				<form id="form-guardar" class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>presupuesto/guardar_presupuesto" method="POST">
		<div class="col-md-12 col-sm-12 col-xs-12">
		<br>
				<div class="col-md-1 col-sm-1 col-xs-1">
					  ...
					  <?php foreach ($presupuesto->result() as $data): ?>
					  ...
					  <?$fecha=date('d-m-Y')?>
							<input type="text" name="" id="" class="form-control" value="<?=$fecha?>" required="required" readonly>
					</div>
					<div class="col-md-1 col-sm-1 col-xs-1">
						<h5 ><P ALIGN="RIGHT"><label># Cot:</label></h5 ></P>
					</div>
					  <div class="col-md-2 col-sm-2 col-xs-2">
						<input type="text" name="txt_id_presupuesto" id="txt_id_presupuesto" class="form-control" value="<?=$data->id_presupuesto?>" required="required" readonly>
					  <?php endforeach ?>
					</div>
		</div>
<!--**********************************************************************************-->
...
<hr>
	...
	<div class="col-md-1 col-sm-1 col-xs-1">
		<button class="btn btn-default " onclick="guardar_det_producto()" name="btn_enviar_producto"id="btn_enviar_producto" type="submit">Agregar</button>
	</div>
	</div>
<div class="col-md-12 col-sm-12 col-xs-12">
<div id="det_presupuesto">
<hr>
...
<?php endforeach ?>
 ...
 <div class="col-md-8 col-sm-8 col-xs-8">
  ...
  <a href="<?php echo $this->config->base_url();?>presupuesto"><button type="button" class="btn btn-danger">Cancelar</button></a></P>
 </div>
