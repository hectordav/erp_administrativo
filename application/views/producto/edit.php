<div class="right_col" role="main" style="height:1040px;">
	...
	<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>producto/actualizar_producto" method="POST">
						<div class="col-md-12 col-sm-12 col-xs-12">
...
<!--*****************************************************************************-->
	...
	<input type="hidden" name="txt_id_producto" id="txt_id_producto" value="<?=$data->id ?>">
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-2 col-sm-2 col-xs-2">
		  ...
		  <div class="col-md-10 col-sm-10 col-xs-10">
			<input type="text" name="txt_cod_producto" id="txt_cod_producto" class="form-control" value="<?=$data->cod_producto ?>">
			</div>
	</div>
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="col-md-2 col-sm-2 col-xs-2">
		  ...
		  <div class="col-md-10 col-sm-10 col-xs-10">
			<input type="text" name="txt_producto" id="txt_producto" class="form-control" value="<?=$data->producto ?>">
			</div>
	</div>
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					  ...
					  <div class="col-md-10 col-sm-10 col-xs-10">
							<input type="number" name="txt_p_compra" id="txt_p_compra" class="form-control" value="<?=$data->precio_compra?>">
						</div>
	</div>
	<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					  ...
					  <div class="col-md-10 col-sm-10 col-xs-10">
							<input onkeyup="fncSumar();" type="number" name="txt_ganancia" id="txt_ganancia" class="form-control" value="<?=$data->ganancia ?>">
						</div>
	</div>
	<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					  ...
					  <div class="col-md-10 col-sm-10 col-xs-10">
							<input type="number" name="txt_precio_neto" id="txt_precio_neto" class="form-control" readonly value="<?=$data->precio_neto ?>">
						</div>
	</div>
		<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					  ...
					  <div class="col-md-10 col-sm-10 col-xs-10">
							<input type="number" name="txt_iva" id="txt_iva" class="form-control" readonly value="<?=$data->iva ?>">
						</div>
	</div>
	<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					  ...
					  <div class="col-md-10 col-sm-10 col-xs-10">
							<input type="number" name="txt_pvp" id="txt_pvp" class="form-control" readonly value="<?=$data->cod_producto ?>">
						</div>
	</div>
